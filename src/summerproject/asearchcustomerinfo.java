 ...
 * @author SUJAL
 */
public class asearchcustomerinfo extends javax.swing.JFrame {
...
//            tb.getColumnModel().getColumn(3).setPreferredWidth(20);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(asearchcustomerinfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new asearchcustomerinfo().setVisible(true);
            }
        });
    }
